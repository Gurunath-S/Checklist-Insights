...
import { getOrganisationDetailsApi, getOrganisationChartDataApi } from '../services/dashboardService';
...
import ChecklistExplorer from '../../analytics/components/ChecklistExplorer';
  ...
  useEffect(() => {
    const fetchOrganisationData = async () => {
      ...
      try {
        ...
        const data = await getOrganisationDetailsApi(organisation.id, params);
        setData(data);
        setError(null);
      } catch (err) {
  ...
  useEffect(() => {
    ...
    const fetchChartData = async () => {
      ...
      try {
        ...
        const resData = await getOrganisationChartDataApi(organisation.id, params);
